 ...
 * @param usersType - The types of users who will see the current item in the main button menu.
 ...
 * @param items - The main button items that are added to the current item as a drop-down list.
 * In this case, the onClick event does not work.
 * @param devices - The types of devices where the current item will be displayed in the main button menu.
