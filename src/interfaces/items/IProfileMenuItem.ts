 ...
 * @param usersType - The types of users who will see the current item in the profile menu.
 ...
 * @param devices - The types of devices where the current item will be displayed in the profile menu.
